/*
 * Static `dvi_timing` tables for the supported resolutions and the
 * DMA-list builders that frank_dvi.c chains together for vsync, vblank,
 * active and audio-island scanlines.
 *
